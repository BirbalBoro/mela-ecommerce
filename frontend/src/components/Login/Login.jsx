...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:rounded-t-lg sm:mx-auto sm:w-full sm:max-w-md border-[#000] border border-b-0 h-[70px] flex justify-center items-center">
        <h2 className="text-center text-3xl font-extrabold text-gray-900">
          Login
        </h2>
      </div>
      <div className="mt-0 sm:mx-auto sm:w-full sm:max-w-md sm:rounded-b-lg border-[#000] border">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className={`${styles.noramlFlex} w-full flex justify-center`}>
              <h4>Don't have an account?</h4>
              <Link to="/sign-up" className="text-teal-600 pl-2">
                Sign Up
              </Link>
            </div>
          </form>
