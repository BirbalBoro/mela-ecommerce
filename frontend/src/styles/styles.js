const styles = {
    ...
    heading: 'text-[27px] text-center md:text-start font-[600] font-Roboto',
    section:'w-11/12 mx-auto rounded-lg box-border',
    productTitle: 'text-[25px] font-[600] font-Roboto text-[#333]',
    productDiscountPrice:"font-bold text-[18px] text-[#333] font-Roboto",
    price:"font-[500] text-[16px] text-[#737373] line-through",
    shop_name:"pt-3 text-[14px] font-[600] text-[#20b2aa] pb-3",
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[teal]",
